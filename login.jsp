...
<!-- 	<tr> -->
<%--       <td><font size="3"><bean:message key="label.comment"/></font></td> --%>
<%--       <td><html:text property="comment" size="20" maxlength="50" /></td> --%>
<!--     </tr> -->

<!--     <tr> -->
<%--       <td><font size="3"><bean:message key="label.mailaddress"/></font></td> --%>
<%--       <td><html:text property="mailaddress" size="20" maxlength="50" /></td> --%>
<!--     </tr> -->
